...
- Added rate limiting per request type such as GET, POST configured via environment variables. [#580](https://github.com/stac-utils/stac-fastapi-elasticsearch-opensearch/pull/580)
