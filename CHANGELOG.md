...
- Added Docker Compose deployment files for quick setup with pre-built images from GHCR. [#691](https://github.com/stac-utils/stac-fastapi-elasticsearch-opensearch/pull/691)
