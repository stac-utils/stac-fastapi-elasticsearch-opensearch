...
extensions = [
    TransactionExtension(client=TransactionsClient(session=session, database=database_logic), settings=settings),
    BulkTransactionExtension(client=BulkTransactionsClient(session=session, database=database_logic)),
    FieldsExtension(),
    QueryExtension(),
    SortExtension(),
    TokenPaginationExtension(),
...
api = StacApi(
    ...
    client=CoreClient(session=session, post_request_model=post_request_model, database=database_logic),
