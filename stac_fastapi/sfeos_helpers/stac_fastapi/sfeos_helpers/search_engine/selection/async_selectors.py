...
from .base import BaseAsyncIndexSelector
from .cache_manager import AsyncIndexAliasLoader, IndexCacheManager


class AsyncDatetimeBasedIndexSelector(BaseAsyncIndexSelector):
    ...
    def __new__(cls, client):
        ...
        Returns:
            AsyncDatetimeBasedIndexSelector: Singleton instance.
        """
