...
from .base import BaseAsyncIndexInserter
from .index_operations import IndexOperations
from .managers import DatetimeIndexManager
from .selection import AsyncDatetimeBasedIndexSelector


class AsyncDatetimeIndexInserter(BaseAsyncIndexInserter):
    ...
    async def get_target_index(
        ...
        """
        index_selector = AsyncDatetimeBasedIndexSelector(self.client)
    ...
    async def prepare_bulk_actions(
        ...
        await self._ensure_indexes_exist(index_selector, collection_id)
    ...
    async def _ensure_indexes_exist(self, index_selector, collection_id: str):
...
class AsyncSimpleIndexInserter(BaseAsyncIndexInserter):
