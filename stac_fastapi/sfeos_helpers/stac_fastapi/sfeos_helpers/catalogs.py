...
async def catalogs(
    ...
    (
        ...
        next_search_after,
        total_hits,
    ) = await client.database.get_all_catalogs(
        token=search_after,
        limit=limit,
        request=request,
...
async def delete_catalog(
    ...
    try:
        ...
        children = await search_collections_by_parent_id_shared(
            client.database.client, catalog_id
        )
...
async def get_catalog_collections(
    ...
    try:
        ...
        (
            ...
            client.database.client, catalog_id, limit, search_after
        )
        ...
        try:
            ...
            if catalog_id not in parent_ids_set:
                ...
                await update_catalog_in_index_shared(
                    client.database.client, catalog.id, existing_catalog
                )
                logger.info(
...
async def create_catalog_collection(
    ...
    try:
        ...
        try:
            ...
            updated_collection = client.collection_serializer.db_to_stac(
            ...
            # Convert back to STAC format for the response
            created_collection = client.collection_serializer.db_to_stac(
                collection_db,
                request,
                extensions=[type(ext).__name__ for ext in client.database.extensions],
            )
