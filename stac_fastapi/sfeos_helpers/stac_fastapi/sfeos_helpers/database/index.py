...
def filter_indexes_by_datetime(
    ...
    def check_criteria(
        value_begin: datetime, value_end: datetime, criteria: Dict, start_value_begin: Optional[datetime] = None    ) -> bool:
    ...
    for index_tuple in collection_indexes:
        ...
        if end_datetime_alias:
            ...
            if not check_criteria(
                    end_date[0], end_date[1], datetime_search.get("end_datetime", {}), start_begin
            ):
                continue
        if datetime_alias:
